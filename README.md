...
- **浮动窗口**：Ghostty 终端和 OpenCode AI 助手自动设为浮动，并绑定快速切换快捷键
- **i3wm 风格键位**：使用 `alt` 作为主要修饰键，支持方向键导航、窗口移动和布局调整
...
- `alt-shift-semicolon` 进入 service 模式后按 `f` - 手动切换当前窗口的浮动/平铺状态
